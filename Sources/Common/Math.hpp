...
namespace math
{
    ...
    {
        auto angleRad = static_cast<float>(angle * (M_PI / 180.0f));
        return {
            v.x,
    ...
    {
        auto halfFovRad = static_cast<float>((fov / 2) * (M_PI / 180.0f));
